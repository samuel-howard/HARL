...
from harl.common.buffers.on_policy_sr_actor_buffer import OnPolicySRActorBuffer
from harl.common.buffers.on_policy_sr_critic_buffer_ep import OnPolicySRCriticBufferEP
from harl.common.buffers.on_policy_sr_critic_buffer_fp import OnPolicySRCriticBufferFP
...
class OnPolicySRBaseRunner:
    """Base runner for on-policy sample reuse algorithms."""

    def __init__(self, args, algo_args, env_args):
        """Initialize the OnPolicySRBaseRunner class.
        Args:
        ...
        if self.algo_args['render']['use_render'] is False:  # train, not render
            ...
            if self.state_type == "EP":
                ...
                self.critic_buffer = OnPolicySRCriticBufferEP(
                ...
                self.critic_buffer = OnPolicySRCriticBufferFP(
                    {**algo_args["train"], **algo_args["model"], **algo_args["algo"]},
                    share_observation_space,
                    self.num_agents,
                )
